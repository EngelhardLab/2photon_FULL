...
function h = legendTitle ( hLegend, string, varargin )
  ...
  if ~verLessThan('matlab', '8.4')
    ...
    if ~isfield ( hLegend.UserData, 'legendTitle' )
      ...
      addlistener ( hLegend.Axes, 'Position', 'PostSet', @(obj,event)UpdateLegendTitlePosition( hLegend, ax ));
      addlistener ( hLegend.Axes, 'OuterPosition', 'PostSet', @(obj,event)UpdateLegendTitlePosition( hLegend, ax ));
