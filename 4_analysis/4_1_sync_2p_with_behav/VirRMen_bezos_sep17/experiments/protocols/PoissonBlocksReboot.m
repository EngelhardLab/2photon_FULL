function [mazes, criteria, globalSettings, vr] = PoissonBlocksReboot(vr)
  ...
  mazes     = struct( 'lStart'          , {5     , 30    , 30    , 30    , 30    , 30    , 30    , 30    , 30    , 30    , 30         , 30              , 30                   , 30                   , 30                   , 30                   }   ...
                    , 'lCue'            , {45    , 120   , 220   , 300   , 380   , 380   , 380   , 380   , 320   , 250   , 250        , 250             , 250                  , 250                  , 250                  , 250                  }   ...
                    , 'lMemory'         , {10    , 20    , 20    , 20    , 20    , 20    , 20    , 20    , 80    , 150   , 150        , 150             , 150                  , 150                  , 150                  , 150                  }   ...
                    ...
                    , 'cueVisibleAt'    , {inf   , inf   , inf   , inf   , inf   , inf   , 30    , 10    , 10    , 10    , 10         , 10              , 10                   , 10                   , 10                   , 10                   }   ...
                    , 'cueProbability'  , {inf   , inf   , inf   , inf   , inf   , inf   , inf   , inf   , inf   , inf   , 2.5        , 2.0             , 1.6                  , 1.2                  , 1.2                  , 1.2                  }   ...
                    , 'cueDensityPerM'  , {3     , 3.8   , 3.8   , 3.8   , 3.8   , 3.8   , 4.2   , 4.2   , 4.2   , 4.2   , 4.5        , 4.6             , 4.8                  , 5                    , 5                    , 5                    }   ...
                    );                                                                                                                                                                                                                              
  criteria  = struct( 'numTrials'       , {10    , 40    , 80    , 80    , 80    , 80    , 80    , 80    , 80    , 80    , 80         , 80              , 80                   , 80                   , 80                   , 80                   }   ...
                    , 'numTrialsPerMin' , {3     , 3     , 3     , 3     , 3     , 3     , 3     , 3     , 3     , 3     , 3          , 3               , 3                    , 3                    , 3                    , 3                    }   ...
                    , 'warmupNTrials'   , {[]    , []    , []    , []    , []    , 30    , 30    , 30    , 30    , 30    , [10  ,15  ], [5   ,10  ,15  ], [2   ,5   ,8   ,10  ], [2   ,5   ,8   ,10  ], [2   ,5   ,8   ,10  ], [2   ,5   ,8   ,10  ]}   ...
                    , 'numSessions'     , {0     , 0     , 0     , 0     , 2     , 1     , 1     , 1     , 1     , 2     , 2          , 2               , 2                    , 2                    , 1                    , 1                    }   ...
                    ...
                    , 'warmupMaze'      , {[]    , []    , []    , []    , []    , 5     , 5     , 5     , 5     , 5     , [5   ,10  ], [5   ,10  ,11  ], [5   ,10  ,11  ,12  ], [5   ,10  ,11  ,12  ], [5   ,10  ,12  ,13  ], [5   ,10  ,12  ,14  ]}   ...
