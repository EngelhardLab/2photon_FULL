function [mazes, criteria, globalSettings, vr] = PoissonBlocksC3_nocues(vr)
  ...
  mazes     = struct( 'lStart'          , {30    , 30    }   ...
                    , 'lCue'            , {220   , 220   }   ...
                    , 'lMemory'         , {80    , 80    }   ...
                    , 'tri_turnHint'    , {true  , true  }   ...
                    , 'cueDuration'     , {-0.1  , -0.1  }   ... seconds %duration of maze 11 was 0.2 until 3-11-16 (not included)
                    , 'cueVisibleAt'    , {10    , 10    }   ...
  ...
  criteria  = struct( 'numTrials'       , {10000 , 100   }   ...
                    , 'numTrialsPerMin' , {3     , 3     }   ... 
                    , 'warmupNTrials'   , {[]    , []    }   ...
                    , 'numSessions'     , {1     , 1     }   ...
                    , 'performance'     , {.9    , .9    }   ...
