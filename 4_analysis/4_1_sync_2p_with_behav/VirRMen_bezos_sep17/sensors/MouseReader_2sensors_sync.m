...
% MouseReader_2sensors_sync accumulates data from the serial port into its internal buffer. When
...
% class property.
%
classdef MouseReader_2sensors_sync < handle
	...
	methods
		...
		% constructor
		function [ obj ] = MouseReader_2sensors_sync( port_name )
...
%                 stopasync(obj.serial_port);
		...
		function [] = poll_mouse( obj )
            ...
            try
                fprintf(obj.serial_port, '%c', obj.REQ_CHAR, 'sync');
                obj.update_delta_xy();
            catch exception
