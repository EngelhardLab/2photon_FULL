function [rw_times,end_trial_times_2p,end_trial_times_rw] = check_rw_times_2p_behav(syncdata_folder,behav_file,csv_data,frames_behav_time_vec,frames_2p_time_vec,do_weird)
...
if ~isempty(weird_idx)
    ...
    dffs_rw   = diff(rw_times);
    fig = figure;
    plot(csv_data.Input1);
    savefig(fig,[syncdata_folder,'csv_dat_Input1.fig']);
    save([syncdata_folder,'weird_idx.mat'],'weird_idx','dffs_rw', 'rw_times','end_trial_times_rw');
